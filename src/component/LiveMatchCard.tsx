      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2 w-2/5">
            ...
            />
            <span className="font-medium truncate">{team1.teamShortName}</span>
          </div>
          ...
          <div className="flex items-center space-x-2 w-2/5 justify-end">
            <span className="font-medium truncate">{team2.teamShortName}</span>
            <img
        ...
        <div className="mb-3 space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">{team1.teamShortName}</span>
            <span className="font-semibold">{formatScore(team1)}</span>
          </div>

          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">{team2.teamShortName}</span>
