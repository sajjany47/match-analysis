      ...
      {Object.keys(newData).length === 0 ? (
        ...
        <div className="container mx-auto py-8 px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              <Tabs
                defaultValue={newData.squadList[0].shortName}
                className="w-full"
              >
                          ...
                          <>
                            <div className="sm:col-span-2 md:col-span-3 lg:col-span-4 flex items-center gap-3 px-2 py-1.5 bg-green-50 rounded-lg border border-green-100">
                              ...
                              <span className="ml-auto text-xs font-medium px-2 py-0.5 bg-green-100 text-green-800 rounded-full">
                                {squad.playingPlayer.length} players
                              </span>
                            </div>

                            {squad.playingPlayer.map(
                              (player: any, i: number) => (
                            ...
                            <div className="sm:col-span-2 md:col-span-3 lg:col-span-4 flex items-center gap-3 px-2 py-1.5 bg-amber-50 rounded-lg border border-amber-100 mt-2">
                              ...
                              <span className="ml-auto text-xs font-medium px-2 py-0.5 bg-amber-100 text-amber-800 rounded-full">
                                {squad.benchPlayer.length} players
                              </span>
                            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      {data?.venue?.pitchType?.toLowerCase()} pitches. Teams
                      batting first have won{" "}
                      {data?.venue?.matchesWonBattingFirst} matches (
                      {(
                        ((data?.venue?.matchesWonBattingFirst ?? 0) /
                          totalMatches) *
                        100
                      ...
                      (
                      {(
                        (data?.venue?.matchesWonBattingSecond ??
                          0 / totalMatches) * 100
                      ).toFixed(1)}
                    ...
                    <p className="text-muted-foreground mt-2">
                      ...
                      {data?.venue?.averageFirstInningsScore}, with the highest
                      team total being {data?.venue?.highestTeamTotal} and the
                      lowest being {data?.venue?.lowestTeamTotal}.
